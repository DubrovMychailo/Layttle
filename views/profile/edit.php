...
<div class="container mt-5">
    ...
    <form method="POST" enctype="multipart/form-data" action="/profile">
        ...
        <div class="mb-3 text-center">
            <label for="cover_photo" class="form-label">Обкладинка профілю:</label>
        ...
        <div class="mb-3">
            ...
            <textarea name="bio" id="bio" class="form-control" rows="3"><?= htmlspecialchars($userData['bio'] ?? '') ?></textarea>
        </div>
